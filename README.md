...
[![Last Commit](https://img.shields.io/github/last-commit/doorm-ai/Genmount-Finetune-Workbench)](https://github.com/doorm-ai/Genmount-Finetune-Workbench/commits/main)
[![Stars](https://img.shields.io/github/stars/doorm-ai/Genmount-Finetune-Workbench?style=social)](https://github.com/doorm-ai/Genmount-Finetune-Workbench/stargazers)
...
This is **Genmount Finetune Workbench**, the L2 training workbench in the **DOORM Genmount WorldModel-OS** architecture: a fully model-agnostic LoRA fine-tuning pipeline that treats data quality as a contract, not a benchmark target.
...
- **💬 [Discussions](https://github.com/doorm-ai/Genmount-Finetune-Workbench/discussions)** for early design feedback
- **📬 [Issues](https://github.com/doorm-ai/Genmount-Finetune-Workbench/issues)** for post-release bug reports
...
- 🛠 **[Genmount WorldModel-OS](https://github.com/doorm-ai/Genmount-WorldModel-OS)** — L1 platform skeleton (sibling repo)
